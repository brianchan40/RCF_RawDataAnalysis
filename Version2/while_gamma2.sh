...
do
    ...
    hadd ./temp/Data_${number4}_${number2}/t${number3}cen${number2}.gamma112_fullEP_eff_pT02_module.root ./temp/Data_${number4}_${number2}/Data_${number3}*/t_${number3}*cen${number2}.gamma112_fullEP_eff_pT02_module.root
