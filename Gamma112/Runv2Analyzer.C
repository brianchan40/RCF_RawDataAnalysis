...
//_________________
void Runv2Analyzer(const int cen = 1, const int opt_weight = 1, const Char_t *inFile = "/star/u/brian40/PicoDst/PicoDst_NoMaker/Version2/file.list", const TString JobIDName = "1234") {
  ...
  gSystem->Load("/star/u/brian40/PicoDst/PicoDst_NoMaker/Gamma112/namespaces/gv_gamma_cpp.so");
  ...
  gROOT->ProcessLine(".!rm -f v2_module_C* ");
}
