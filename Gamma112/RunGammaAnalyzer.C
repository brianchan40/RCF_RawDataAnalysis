...
//_________________
void RunGammaAnalyzer(const int cen = 1, const int opt_weight = 1, const Char_t *inFile = "/star/u/brian40/PicoDst/PicoDst_NoMaker/Version2/file.list", const TString JobIDName = "1234") {
